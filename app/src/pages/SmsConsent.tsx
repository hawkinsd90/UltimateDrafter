...
export default function SmsConsent() {
  return (
    <div style={{ padding: '40px', fontFamily: 'system-ui, sans-serif', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1 style={{ marginTop: '20px' }}>SMS Consent & Messaging Information</h1>
      <p style={{ color: '#6b7280' }}>Last updated: {new Date().toLocaleDateString()}</p>

      <section style={{ marginTop: '30px' }}>
        <h2>SMS Opt-In Workflow</h2>
      ...
      <section style={{ marginTop: '30px' }}>
        ...
        <p><strong>Offline4ever DraftMaster collects phone numbers solely for account security and draft-related notifications. We do not send marketing messages.</strong></p>

        <h3 style={{ marginTop: '20px' }}>1. OTP Verification Messages</h3>
        <p>When you verify your phone number, you will receive a message like:</p>
        <div style={{ background: '#f3f4f6', padding: '15px', borderRadius: '6px', fontFamily: 'monospace', marginTop: '10px' }}>
          "Your Offline4ever DraftMaster verification code is: 123456"
        </div>

        <h3 style={{ marginTop: '20px' }}>2. Draft Turn Notifications</h3>
        ...
        <h3 style={{ marginTop: '20px' }}>3. Security Alerts</h3>
        <p>Critical account security notifications (e.g., password changes, suspicious login attempts)</p>
      </section>

      <section style={{ marginTop: '30px', padding: '20px', background: '#fef3c7', borderRadius: '8px' }}>
        <h2 style={{ marginTop: '0' }}>Important: Transactional Messages Only</h2>
